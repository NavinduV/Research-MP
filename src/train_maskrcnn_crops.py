...
Usage:
    ...
    python src/train_maskrcnn_crops.py --mode prepare --images data/stitched --yolo experiments/microplastic_yolo/weights/best.pt
    
    # Train Mask R-CNN on crops
    python src/train_maskrcnn_crops.py --mode train --epochs 50
    
    # Test on a single crop
    python src/train_maskrcnn_crops.py --mode predict --image path/to/crop.png
"""
