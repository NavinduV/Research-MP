...
Usage:
    ...
    python src/data_preparation/sam_auto_annotate.py --mode annotate --crops-dir data/crops
    
    # Visualize generated masks
    python src/data_preparation/sam_auto_annotate.py --mode visualize --crops-dir data/crops --num-samples 20
    
    # Visualize specific image
    python src/data_preparation/sam_auto_annotate.py --mode visualize --image data/crops/images/sample.png
...
def main():
    ...
    if args.mode == 'annotate':
        ...
        print(f"\nNext steps:")
        print(f"1. Visualize masks: python src/data_preparation/sam_auto_annotate.py --mode visualize --crops-dir {output_path}")
