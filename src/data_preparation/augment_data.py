...
Usage:
    ...
    python src/data_preparation/augment_data.py --input data/yolo --output data/yolo_augmented --target-train 800 --target-val 200
    
    # Standard augmentation (10x, medium severity)
    python src/data_preparation/augment_data.py --input data/yolo --output data/yolo_augmented --factor 10
    
    # Heavy augmentation for very small datasets (20x)
    python src/data_preparation/augment_data.py --input data/yolo --output data/yolo_augmented_heavy --factor 20 --severity heavy
    
    # Also augment validation set (useful for very small datasets)
    python src/data_preparation/augment_data.py --input data/yolo --output data/yolo_augmented --factor 10 --augment-val --val-factor 3
"""
...
"""
    ...
    print(f"    python src/train/train_yolo.py --mode train --data {output_path}/dataset.yaml \\")
...
Examples:
  ...
  # Heavy augmentation for very small datasets (20x)
  python src/data_preparation/augment_data.py --input data/yolo --output data/yolo_aug_heavy --factor 20 --severity heavy
