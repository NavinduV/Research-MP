...
Usage:
    ...
    python src/train/train_maskrcnn.py --mode train --epochs 50
    
    # Validate model
    python src/train/train_maskrcnn.py --mode val --model experiments/maskrcnn_best.pth
    
    # Predict on an image
    python src/train/train_maskrcnn.py --mode predict --model experiments/maskrcnn_best.pth --image path/to/image.png
"""
